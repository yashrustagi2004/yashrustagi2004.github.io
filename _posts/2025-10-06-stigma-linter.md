...
```yaml
{
  ...
  "formatted_code":"title: !!python/object/apply:subprocess.Popen\n- ls\nlogsource:\n category: process_creation\n product: windows\ndetection:\n selection:\n Image: '*\\\\cmd.exe'\n CommandLine: '* /c *'\n condition: selection\nlevel: medium\ndescription: Detects suspicious command execution\nauthor: Security Team",
  "reasons":["Unexpected error: cannot pickle '_thread.lock' object"],
  "result":false
  }
```
...
{
  "error_type":"validation",
  "formatted_code":"title: flag{b692115306c8e5c54a2c8908371a4c72}\nlogsource:\n  category: process_creation\n  product: windows\n",
  "reasons":["'detection' is a required property"],
  "result":false
  }
```
